...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-7731cea2');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-7731cea2');}
...
function clearFlash(){dieView.classList.remove('rl-win-7731cea2');dieView.classList.remove('rl-lose-7731cea2');if(frameEl){frameEl.classList.remove('rl-win-7731cea2');frameEl.classList.remove('rl-lose-7731cea2');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-7731cea2');if(frameEl){frameEl.classList.add('rl-win-7731cea2');}}else{dieView.classList.add('rl-lose-7731cea2');if(frameEl){frameEl.classList.add('rl-lose-7731cea2');}}
...
var brandEl=document.querySelector('.rl-brand-7731cea2');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
